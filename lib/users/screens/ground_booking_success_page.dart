...
class GroundBookingSuccessPage extends StatelessWidget {
  ...
  const GroundBookingSuccessPage({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Your ground booking is successfully confirmed',
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildDetailRow('Ground Name', booking['name'] ?? 'N/A'),
            _buildDetailRow('Location', booking['location'] ?? 'N/A'),
            _buildDetailRow('Booking Date', booking['date'] ?? 'Today'),
            _buildDetailRow('Time Slot', booking['timeSlot'] ?? 'N/A'),
            _buildDetailRow('Ground Size', booking['size'] ?? 'N/A'),
            _buildDetailRow('Facilities', booking['facilities'] ?? 'N/A'),
            _buildDetailRow('Hourly Rate', booking['price'] ?? 'N/A'),
          ],
        ),
      ),
    );
          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 15),
                _buildPDFRow('Ground Name:', booking['name'] ?? 'N/A'),
                _buildPDFRow('Location:', booking['location'] ?? 'N/A'),
                _buildPDFRow('Booking Date:', booking['date'] ?? 'Today'),
                _buildPDFRow('Time Slot:', booking['timeSlot'] ?? 'N/A'),
                _buildPDFRow('Ground Size:', booking['size'] ?? 'N/A'),
                _buildPDFRow('Facilities:', booking['facilities'] ?? 'N/A'),
                _buildPDFRow('Hourly Rate:', booking['price'] ?? 'N/A'),
                pw.SizedBox(height: 30),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    'Thank you for booking with VenueVista! Enjoy your game!',
                    style: pw.TextStyle(
                      fontSize: 12,
  ...
  Future<void> _savePDFWithFallback(
    ...
    try {
      ...
      await Printing.sharePdf(
        ...
        filename: 'VenueVista_Booking_Receipt_$transactionId.pdf',
      );
      ...
      try {
        ...
        await Printing.layoutPdf(
          ...
          name: 'VenueVista_Booking_Receipt_$transactionId.pdf',
        );
